...
public class VendedoraControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<VendedoraModel> requisicao = new HttpEntity<VendedoraModel>(new VendedoraModel(0L, 
				"Joana da Silva", "42678596321", "https://i.imgur.com/FETvs2O.jpg",
                "Rua dos bobos numero zero", "01140028922", "joanadasilva@email.com", "joaninha123"));
	...
	public void naoDeveDuplicarUsuario() {
		...
		vendedoraService.cadastrarUsuario(new VendedoraModel(0L, 
				"Joana da Silva", "42678596321", "https://i.imgur.com/FETvs2O.jpg",
                "Rua dos bobos numero zero", "01140028922", "joanadasilva@email.com", "joaninha123"));
	...
	public void deveMostrarTodosUsuarios() {
		...
		ResponseEntity<String> resposta = testRestTemplate
			.withBasicAuth("root", "root")
			.exchange("/vendedora/all", HttpMethod.GET, null, String.class);
